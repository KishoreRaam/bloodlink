...
import { User, Bell, Shield, Moon, Sun, Save, Globe, Lock, Eye, EyeOff } from "lucide-react";
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        >
              ...
              <div className="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-lg border border-[#E5E7EB] dark:border-gray-600 bg-[#F9FAFB] dark:bg-[#0D1117]/50 text-[#111827] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#C0152A]/30 focus:border-[#C0152A] transition-all"
                    style={{ fontSize: "13px" }}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div
                    className="w-full px-3 py-2.5 rounded-lg border border-[#E5E7EB] dark:border-gray-700 bg-[#F3F4F6] dark:bg-gray-700/30 text-[#6B7280] dark:text-gray-400 capitalize"
                    style={{ fontSize: "13px" }}
                  >
                    {user?.role ?? "—"}
                  </div>
              ...
              <div className="px-6 py-5 space-y-4">
                {[
                  ...
                  <div key={item.key} className="flex items-center justify-between py-3 border-b border-[#F3F4F6] dark:border-gray-700/30 last:border-0">
                    <div>
                      <p className="text-[#111827] dark:text-gray-100" style={{ fontSize: "13px", fontWeight: 500 }}>{item.label}</p>
                      <p className="text-[#6B7280] dark:text-gray-400" style={{ fontSize: "12px" }}>{item.desc}</p>
                    </div>
                    <button
                      onClick={() => setNotifications((n) => ({ ...n, [item.key]: !n[item.key] }))}
                      className={`relative w-10 h-5 rounded-full transition-all flex-shrink-0 ${notifications[item.key] ? "bg-[#C0152A]" : "bg-gray-300 dark:bg-gray-600"}`}
                    >
                      <span
            ...
            <div>
              ...
              <div className="px-6 py-5 space-y-5 max-w-[440px]">
                {["Current Password", "New Password", "Confirm New Password"].map((label, i) => (
                  <div key={label}>
                    ...
                    <div className="relative">
                      <input
                        type={showPassword && i === 0 ? "text" : "password"}
                        placeholder="••••••••"
                ...
                <div className="pt-2 p-4 rounded-xl bg-[#F9FAFB] dark:bg-[#0D1117]/40 border border-[#E5E7EB] dark:border-gray-700/50">
                  ...
                  <button
                    className="px-4 py-2 rounded-lg border border-[#C0152A] text-[#C0152A] hover:bg-[#FDECEE] transition-all"
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      >
                        <t.icon className="w-5 h-5" style={{ color: theme === t.value ? "#C0152A" : "#6B7280" }} />
                        <span style={{ fontSize: "12px", fontWeight: theme === t.value ? 600 : 400, color: theme === t.value ? "#C0152A" : "#6B7280" }}>
                          {t.label}
                        </span>
                      </button>
                    ))}
          ...
          <div className="px-6 py-4 border-t border-[#E5E7EB] dark:border-gray-700/50 flex items-center justify-between bg-[#F9FAFB] dark:bg-[#0D1117]/30">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-5 py-2 rounded-lg text-white hover:opacity-90 transition-all"

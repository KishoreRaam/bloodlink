...
export function LandingPage() {
  ...
  return (
    <div className="bg-white min-h-screen font-['Inter',sans-serif]">
      ...
      {/* ── Navbar ── */}
      <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white border-b border-[#e5e7eb] flex items-center justify-between px-6 lg:px-8">
        {/* Logo */}
        ...
        <nav className="hidden md:flex items-center gap-6">
          <button onClick={() => scrollTo("how-it-works")} className="text-[#374151] hover:text-[#d72638] text-sm font-medium transition-colors">How It Works</button>
          <button onClick={() => scrollTo("who-uses")} className="text-[#374151] hover:text-[#d72638] text-sm font-medium transition-colors">About</button>
        </nav>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="hidden sm:block px-4 py-2.5 border-2 border-[#1a1a2e] rounded-lg text-[#1a1a2e] text-sm font-semibold hover:bg-[#1a1a2e] hover:text-white transition-all"
          >
            Login as Admin
          </button>
          <button
            onClick={() => navigate("/donor")}
            className="px-4 py-2.5 bg-[#d72638] rounded-lg text-white text-sm font-semibold shadow-[0px_4px_14px_rgba(215,38,56,0.25)] hover:opacity-90 transition-all"
          >
            Login as Donor
          </button>
        </div>
      ...
      {/* ── Hero ── */}
      <section id="hero" className="bg-[#1a1a2e] pt-16 min-h-screen flex items-center overflow-hidden relative">
        {/* Ambient glow */}
        ...
        <span className="absolute left-14 top-20 text-2xl opacity-30 rotate-6 select-none">🩸</span>
        <span className="absolute left-20 top-60 text-2xl opacity-30 -rotate-5 select-none">🩸</span>
        <span className="absolute left-8 bottom-28 text-2xl opacity-30 rotate-3 select-none">🩸</span>
        <span className="absolute right-20 top-32 text-2xl opacity-30 -rotate-2 select-none">🩸</span>
        <span className="absolute right-28 bottom-32 text-2xl opacity-30 rotate-8 select-none">🩸</span>
        ...
        <div className="max-w-[1160px] mx-auto px-6 lg:px-8 w-full py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-[rgba(215,38,56,0.14)] border border-[rgba(215,38,56,0.31)] rounded-full px-4 py-2 mb-8">
              <span className="text-base">🩸</span>
              <span className="text-[#fca5a5] text-[13px] font-semibold">Emergency Blood Network</span>
            </div>

            {/* Headline */}
            <h1 className="text-white font-extrabold text-[44px] lg:text-[58px] leading-[1.1] tracking-[-1px] mb-6">
            ...
            {/* Subtext */}
            <p className="text-[#9ca3af] text-[18px] leading-[1.7] mb-10 max-w-[470px]">
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              ...
              <button
                onClick={() => navigate("/donor")}
                className="flex items-center gap-2 px-6 py-4 bg-[#d72638] rounded-lg text-white font-semibold text-base shadow-[0px_6px_24px_rgba(215,38,56,0.31)] hover:opacity-90 transition-all"
              >
                🩸 Join as Donor
              </button>
            </div>

            <p className="text-[#6b7280] text-[13px]">✓ Trusted by hospitals across Tamil Nadu &amp; Karnataka</p>
          </div>
                ...
                <div className="pt-1 border-t border-[rgba(255,255,255,0.1)]">
                  <div className="flex items-center gap-2 mt-3">
                    <div className="flex-1 h-1 bg-[rgba(255,255,255,0.1)] rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#d72638] to-[#ff6b7a] rounded-full transition-all duration-700"
      ...
      <section id="how-it-works" className="bg-white py-24 px-6 lg:px-8">
        <div className="max-w-[1160px] mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-[#1a1a2e] font-extrabold text-[36px] tracking-[-0.5px] mb-2">
              How BloodLink Works
            </h2>
            <p className="text-[#6b7280] text-[18px]">Simple. Fast. Life-saving.</p>
          </div>

          {/* Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            {/* Connector arrows */}
            <div className="hidden md:flex absolute top-14 left-1/3 right-1/3 items-center justify-between px-8 z-10 pointer-events-none">
              <div className="flex-1 h-0.5 bg-[rgba(215,38,56,0.19)]" />
              <svg viewBox="0 0 20 20" className="w-5 h-5 text-[#d72638]/60 fill-current flex-shrink-0">
            ...
            {[
              ...
              <div
                key={card.num}
                className="bg-white border border-[#e5e7eb] rounded-[12px] shadow-[0px_1px_3px_rgba(0,0,0,0.06)] p-8 relative group hover:shadow-md transition-shadow"
              >
                <div className="flex items-start justify-between mb-8">
                  <div className="bg-[rgba(215,38,56,0.07)] border border-[rgba(215,38,56,0.14)] rounded-[14px] w-14 h-14 flex items-center justify-center text-2xl">
                    {card.icon}
                  </div>
                  <span className="text-[11px] font-bold tracking-[1.1px] text-[rgba(215,38,56,0.38)]">{card.num}</span>
                </div>
                <h3 className="text-[#1a1a2e] font-bold text-[18px] mb-3">{card.title}</h3>
                <p className="text-[#6b7280] text-[14px] leading-[1.7]">{card.desc}</p>
                {/* Bottom accent */}
        ...
        <div className="max-w-[1160px] mx-auto grid grid-cols-2 md:grid-cols-4">
          {[
            ...
            >
              ...
              <span className="text-[rgba(255,255,255,0.7)] text-[14px]">{stat.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ── Who Uses BloodLink ── */}
      <section id="who-uses" className="bg-[#f5f5f5] py-24 px-6 lg:px-8">
        <div className="max-w-[1160px] mx-auto">
          <h2 className="text-[#1a1a2e] font-extrabold text-[36px] tracking-[-0.5px] text-center mb-14">
            Who Uses BloodLink?
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Donor card */}
            <div className="bg-white border-l-4 border-[#d72638] rounded-[12px] shadow-[0px_1px_3px_rgba(0,0,0,0.06)] p-8 hover:shadow-md transition-shadow">
              <div className="bg-[rgba(215,38,56,0.07)] rounded-[14px] w-14 h-14 flex items-center justify-center text-2xl mb-8">
                🩸
              </div>
              <h3 className="text-[#1a1a2e] font-bold text-[22px] mb-3">Register as a Donor</h3>
              ...
              <button
                onClick={() => navigate("/donor")}
                className="flex items-center gap-2 px-5 py-3 bg-[#d72638] rounded-lg text-white text-[14px] font-semibold shadow-[0px_4px_14px_rgba(215,38,56,0.25)] hover:opacity-90 transition-all"
              >
            ...
            {/* Hospital/Admin card */}
            <div className="bg-white border-l-4 border-[#1a1a2e] rounded-[12px] shadow-[0px_1px_3px_rgba(0,0,0,0.06)] p-8 hover:shadow-md transition-shadow">
              <div className="bg-[rgba(26,26,46,0.07)] rounded-[14px] w-14 h-14 flex items-center justify-center text-2xl mb-8">
                🏥
              </div>
              <h3 className="text-[#1a1a2e] font-bold text-[22px] mb-3">Hospital &amp; Admin Portal</h3>
              <p className="text-[#6b7280] text-[15px] leading-[1.8] mb-8">
                Manage emergency requests, track donor availability, and coordinate blood bank inventory in real time.
              </p>
              <button
                onClick={() => navigate("/login")}
                className="flex items-center gap-2 px-5 py-3 bg-[#1a1a2e] rounded-lg text-white text-[14px] font-semibold hover:opacity-80 transition-all"
              >
                Admin Login
                <svg viewBox="0 0 16 16" className="w-4 h-4 fill-current"><path d="M3 8h10M9 4l4 4-4 4"/></svg>
              </button>
      ...
      {/* ── Footer ── */}
      <footer ref={footerRef} className="bg-[#1a1a2e] border-t-4 border-[#d72638]">
        <div className="max-w-[1160px] mx-auto px-6 lg:px-8 pt-14 pb-8">
          ...
          <div className="border-t border-[rgba(255,255,255,0.1)] pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
            <p className="text-[#6b7280] text-[13px]">© 2026 BloodLink. Built for Emergency Response.</p>
